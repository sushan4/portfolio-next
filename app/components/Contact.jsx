...
const Contact = () => {
  return (
    <section class="bg-black dark:bg-black" id="contact">
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div class="mb-4">
            <div class="mb-6  text-center sm:text-center md:mx-auto md:mb-12">
                ...
                <h2
                    class="font-heading mb-4 font-bold tracking-tight text-gray-900 dark:text-white text-5xl sm:text-5xl">
                    Get in Touch
                </h2>
                    ...
                    <ul class="mb-6 md:mb-0">
                        ...
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">LinkedIn: <a href="https://linkedin.com/in/sushanuchil">linkedin.com/in/sushanuchil</a></p>
                                <p class="text-gray-600 dark:text-slate-400">Mail: uchilsushan36@gmail.com</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
