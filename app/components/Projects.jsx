  ...
  const projectData = [
    {
      ...
      description: "AI-Interviewer is an innovative interview solution powered by Open AI built on the MERN stack. It generates interview questions on a given topic and evaluates speech answers by the user."
    },
    {
      imageUrl: "pocketfund.jpg",
      title: "Pocketfund",
      description: "PocketFund is a DAPP(Decentralized Application) providing an open platform for innovative projects and startups aimed at providing social good.The platform enables small teams/startups to raise necessary funds via crowdfunding through ledger transactions."},
    {
      imageUrl: "laptrends.jpg",
      title: "Laptrends",
      description: "Laptrends is a Price Predictor for Laptops acheiving a prediction accuracy of 89% via utilization of Machine Learning Technologies. It utilizes Streamlit for a simplistic yet powerful UI design."
    }
  ];

  return (
    <div className="container my-12 mx-auto md:px-6" id="projects">
